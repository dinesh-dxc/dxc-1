...
public class HelloServiceLocator extends org.apache.axis.client.Service implements dxc.WebserviceDemo.HelloService {
    ...
    private java.lang.String Hello_address = "http://localhost:8080/WebserviceDemo/services/Hello";
    ...
    public dxc.WebserviceDemo.Hello getHello() throws javax.xml.rpc.ServiceException {
    ...
    public dxc.WebserviceDemo.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            dxc.WebserviceDemo.HelloSoapBindingStub _stub = new dxc.WebserviceDemo.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (dxc.WebserviceDemo.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                dxc.WebserviceDemo.HelloSoapBindingStub _stub = new dxc.WebserviceDemo.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://WebserviceDemo.dxc", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://WebserviceDemo.dxc", "Hello"));
        }
