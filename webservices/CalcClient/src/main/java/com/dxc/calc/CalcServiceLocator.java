...
public class CalcServiceLocator extends org.apache.axis.client.Service implements com.dxc.calc.CalcService {
    ...
    private java.lang.String Calc_address = "http://localhost:8080/CalcService/services/Calc";
    ...
    public com.dxc.calc.Calc getCalc() throws javax.xml.rpc.ServiceException {
    ...
    public com.dxc.calc.Calc getCalc(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.dxc.calc.CalcSoapBindingStub _stub = new com.dxc.calc.CalcSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.dxc.calc.Calc.class.isAssignableFrom(serviceEndpointInterface)) {
                com.dxc.calc.CalcSoapBindingStub _stub = new com.dxc.calc.CalcSoapBindingStub(new java.net.URL(Calc_address), this);
                _stub.setPortName(getCalcWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://calc.dxc.com", "CalcService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://calc.dxc.com", "Calc"));
        }
