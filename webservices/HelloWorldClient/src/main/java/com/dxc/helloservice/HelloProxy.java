...
public class HelloProxy implements com.dxc.helloservice.Hello {
  private String _endpoint = null;
  private com.dxc.helloservice.Hello hello = null;
  ...
  private void _initHelloProxy() {
    try {
      hello = (new com.dxc.helloservice.HelloServiceLocator()).getHello();
      if (hello != null) {
        if (_endpoint != null)
  ...
  public com.dxc.helloservice.Hello getHello() {
    if (hello == null)
      _initHelloProxy();
    return hello;
  }
