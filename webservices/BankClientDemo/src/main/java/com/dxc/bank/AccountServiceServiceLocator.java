...
public class AccountServiceServiceLocator extends org.apache.axis.client.Service implements com.dxc.bank.AccountServiceService {
    ...
    private java.lang.String AccountService_address = "http://localhost:8080/BankServiceDemo/services/AccountService";
    ...
    public com.dxc.bank.AccountService getAccountService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.dxc.bank.AccountServiceSoapBindingStub _stub = new com.dxc.bank.AccountServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.dxc.bank.AccountService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.dxc.bank.AccountServiceSoapBindingStub _stub = new com.dxc.bank.AccountServiceSoapBindingStub(new java.net.URL(AccountService_address), this);
                _stub.setPortName(getAccountServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://bank.dxc.com", "AccountServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://bank.dxc.com", "AccountService"));
        }
